...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 ml-64">
        ...
        <div class="p-6">
            ...
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-2 card-title">Budget Management</h1>
                <p class="text-gray-500 card-text">Manage your budget using the 50/30/20 rule with AI-powered automation</p>
            </div>
